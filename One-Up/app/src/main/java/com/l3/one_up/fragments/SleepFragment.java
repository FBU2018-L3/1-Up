...
public class SleepFragment extends Fragment implements BackIsClickable {
    ...
    /* information for facebook share button */
        ...
        event.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if(e==null){
                    ...
                    InputConfirmationFragment inputFragment = InputConfirmationFragment.newInstance(user.updateExperiencePoints(xp), startLvl, myEvent, null);
